...
DECLARE
  ...
  app RECORD;
BEGIN
  -- Get applications from dealer_purchases instead of application_downloads
  FOR purchase IN
    SELECT p.*
...
-- Update is_application_downloaded_by_dealer to check in dealer_purchases instead of application_downloads

  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow pt-[72px]">
        {/* Hero Section - Updated with SUV image, zoom effect, and bottom-justified positioning */}
        <section 
          ...
          <div className="relative z-10 text-left px-4 md:px-20 w-full max-w-7xl mx-auto">
            <div className="max-w-2xl">
              <h1 className="text-5xl md:text-6xl font-bold mb-6 drop-shadow-lg animate-fade-in">
                Huge Dealer Network <br />
                <span className="text-ontario-gold">Easily Apply Today</span>
              </h1>
        ...
        {/* Benefits Banner - MOVED UP: Now positioned right after hero section */}
        ...
        {/* Our Inventory Section - MOVED UP: Now positioned after benefits banner */}
        ...
        {/* Features - NOW MOVED DOWN: After Our Inventory section */}
